...
public class VWGolf extends Volkswagen {
	...
	private static final float FUEL_TANK_LEVEL = 45f;
	private static final float FUEL_CONSUMPTION_RATE = 4.9f;
	...
	public VWGolf(float currentFuelAmount, String chassisNumber) {
		super(currentFuelAmount, chassisNumber, FUEL_TYPE, NUMBER_OF_GEARS, FUEL_TANK_LEVEL, FUEL_CONSUMPTION_RATE);
	}

	public VWGolf(String chassisNumber, Integer productionYear, float carPrice) {
	...
	public float setConsumptionRate() {
		...
		case 1:
			...
			break;
		case 2:
			averageFuelConsumption = (float) (FUEL_CONSUMPTION_RATE + 0.16);
			values.add(averageFuelConsumption);
			break;
		case 3:
	...
	public String toString() {
		return "VWGolf [Chassis Number=" + super.getChassisNumber() + ", Production Year=" + super.getProductionYear()
				+ "]";
	}
